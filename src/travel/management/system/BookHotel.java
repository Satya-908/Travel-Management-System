...
class BookHotel  extends JFrame implements ActionListener{   
	Choice c1,c2,c3; 
	JTextField t1,t2; 
	...
	BookHotel(String username){
		...
		add(l2);   
		 ...
		 l21= new JLabel(); 
		l21.setFont(new Font("Tahoma",Font.PLAIN,24)); 
		...
		add(l8);   
		 ...
		 l22= new JLabel(); 
		l22.setFont(new Font("Tahoma",Font.PLAIN,24)); 
		...
		add(l9);   
		 ...
		 l23= new JLabel(); 
		l23.setFont(new Font("Tahoma",Font.PLAIN,24)); 
