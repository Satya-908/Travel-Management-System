...
public class CheckHotels extends JFrame implements Runnable { 
	...
	JLabel caption;
	public void run() {  
		String [] text=new String[] {"JW Marriot Hotel","Four season Hotel","Radisons Hotel","Classio Hotel","The Bay Club Hotel","Breeze Blows Hotel","Quick Stop Hotel","Happy Mornings Hotel","Moss View Hotel","Tga Hotel"};
